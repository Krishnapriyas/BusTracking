...
<html>
    ...
    <body>
        ...
        <div class="banner">
            <div class="container">
                <h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="text-transform: uppercase;visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> WELCOME ADMIN</h1>
            </div>
        </div>
