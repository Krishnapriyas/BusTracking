...
<html>
    ...
    <body>
        ...
        <div class="header">
            <div class="container">
                <div class="logo wow fadeInDown animated" data-wow-delay=".5s">
                    <a href="index.html">DEZTINO <span></span></a>	
                </div>

                <div class="lock fadeInDown animated" data-wow-delay=".5s"> 
                    <li><i class="fa fa-lock"></i></li>
                    <li><div class="securetxt">SAFE &amp; SECURE<br> TRAVEL</div></li>
                    <div class="clearfix"></div>
                </div>
                <div class="clearfix"></div>
            </div>
        ...
        <div class="banner">
            <div class="container">
                <h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Best in Class for Travel</h1>
            </div>
        </div>
<!--        <div class="container">
