...
<html>
    ...
    <body>
        ...
        <div class="header">
            <div class="container">
                <div class="logo wow fadeInDown animated" data-wow-delay=".5s">
                    <a href="owner_home.jsp">DEZTINO <span></span></a>	
                </div>
        ...
        <div class="banner-3">
            <div class="container">
                <h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;text-transform: uppercase;">WELCOME <%=(String) session.getAttribute("OWNER_NAME")%></h1>
            </div>
        </div>
